...
namespace Realestate.ApiControllers
{
    ...
    public class TranslateController : ApiController    
    {
        ...
        private ResourceRepository _resourceManager;
        public ResourceRepository ResourceManager
        {
            get
            {
                return _resourceManager ?? new ResourceRepository();
            }
            private set
            {
        ...
        private IDictionary<string, Object> getTrans(string lang) {
            List<ResourceResult> result = ResourceManager.GetAllResources(lang);
            var dyn = new ExpandoObject() as IDictionary<string, Object>;

            List<string> groups = result.Select(cat => cat.Group).Distinct().ToList();
            foreach (string group in groups)
            {
                var dynCat = new ExpandoObject() as IDictionary<string, Object>; ;
                foreach (ResourceResult r in result.Where(r => r.Group == group))
                {
                    dynCat.Add(r.Code.ToLower(), r.Value);
                }
                dyn.Add(group.ToLower(), dynCat);
            }
            return dyn;
        }
        ...
        public JToken GetEn()
        {
            ...
            return JObject.Parse(JsonConvert.SerializeObject(getTrans("en")));
...
//            return json;
        ...
        public JToken GetSrCyrl()
        {
            ...
            return JObject.Parse(JsonConvert.SerializeObject(getTrans("sr-cyrl")));
...
//            return json;
        ...
        public JToken GetSrLatin()
        {
            ...
            return JObject.Parse(JsonConvert.SerializeObject(getTrans("sr-latn")));
...
//            return json;
        ...
        public JToken GetZh()
        {
            ...
            return JObject.Parse(JsonConvert.SerializeObject(getTrans("zh")));
...
//            return json;
        ...
        public JToken GetIt()
        {
            ...
            return JObject.Parse(JsonConvert.SerializeObject(getTrans("it")));
