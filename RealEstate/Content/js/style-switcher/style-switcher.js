...
jQuery(document).ready(function() {
	...
	if(default_settings.pattern && default_settings.pattern != 'none') default_settings.pattern = '/content/js/style-switcher/patterns/' + default_settings.pattern + '.png';
	if (default_settings.bg && default_settings.bg != 'none') default_settings.bg = '/content/js/style-switcher/images/' + default_settings.bg + '.jpg';
	...
	jQuery('head').append('<script type="text/javascript" src="' + directory + '/content/js/style-switcher/jquery.cookie.js">');
	...
	if(enable_style_switcher){
		...
		jQuery('head').append('<link type="text/css" rel="stylesheet" href="' + directory + '/content/js/style-switcher/styler.css"/><script type="text/javascript" src="' + directory + 'js/style-switcher/iris.min.js"></script>');
		...
		jQuery('.mtp-background-pattern li').click(function(){
			if (jQuery('.mtp-layout-select').val() == 'full-width'){
				...
				patternUrl = '/content/js/style-switcher/patterns/' + selectedPattern + '.png';
		...
		jQuery('.mtp-background-image li').click(function(){
			if (jQuery('.mtp-layout-select').val() == 'full-width'){
				...
				imgUrl = '/content/js/style-switcher/images/' + selectedImg + '.jpg';
